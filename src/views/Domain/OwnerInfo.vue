<template>
 <v-layout>
   <page-container>
     <div class="bas-gray-bg" slot="body">
       <div class="container">
             ...
             <div class="bas-card__body">
              ...
              <div class="bas-whois--second">
                ...
                <div class="bas-whois--right-container">
                  ...
                  <div class="bas-whois-btn-container">
                    <button class="btn bas-primary-btn">去注册</button>
                  </div>
                </div>
              </div>
             </div>
